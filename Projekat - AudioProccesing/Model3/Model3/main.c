...
DSPfract variablesGainL[DEFAULT_OUTPUT_NUM_CHANNELS][INPUT_NUM_CHANNELS] = {MINUS_4DB, PLUS_4DB};
DSPfract variablesGainR[DEFAULT_OUTPUT_NUM_CHANNELS][INPUT_NUM_CHANNELS] = {MINUS_4DB, PLUS_4DB};
DSPfract variablesGainLS[DEFAULT_OUTPUT_NUM_CHANNELS][INPUT_NUM_CHANNELS] = {MINUS_4DB, PLUS_4DB};
DSPfract variablesGainRS[DEFAULT_OUTPUT_NUM_CHANNELS][INPUT_NUM_CHANNELS] = {MINUS_4DB, PLUS_4DB};
DSPfract variablesGainC[DEFAULT_OUTPUT_NUM_CHANNELS][INPUT_NUM_CHANNELS] = {MINUS_4DB, PLUS_4DB};
...
// Filter buffers
DSPfract historyL[FILTERLEN];
DSPfract historyR[FILTERLEN];
DSPfract historyLS[FILTERLEN];
DSPfract historyRS[FILTERLEN];
DSPfract historyC[FILTERLEN];

DSPfract* pStateL = historyL;
DSPfract* pStateR = historyR;
DSPfract* pStateLS = historyLS;
DSPfract* pStateRS = historyRS;
DSPfract* pStateC =  historyC;
...
{
	int j;
	DSPfract* historyPtr1 =  historyL;
	DSPfract* historyPtr2 =  historyR;
	DSPfract* historyPtr3 =  historyLS;
	DSPfract* historyPtr4 =  historyRS;
	DSPfract* historyPtr5 =  historyC;
...
extern void fir_circular(DSPfract input, DSPfract **p_state, DSPfract *state_start, DSPfract *state_end);
#else
